...
export default async function getStandings(groupNum: string) {
    ...
    let res;
    try {
        res = await fetch(`http://sports.core.api.espn.com/v2/sports/football/leagues/nfl/seasons/${currentSeason}/types/2/groups/${groupNum}/standings/0`, { 
            method: "get" 
        });    
        if (!res.ok) throw new Error("Something went wrong");
    }
    catch (error) {
        res = await fetch(`http://sports.core.api.espn.com/v2/sports/football/leagues/nfl/seasons/${currentSeason-1}/types/2/groups/${groupNum}/standings/0`, { 
            method: "get" 
        });
