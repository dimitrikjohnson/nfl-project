        ...
        return (
            <>
                { teamLeaders.map(stat =>
                    <div 
                        key={ stat.statName + stat.playerName } 
                        className="bg-sectionColor grid justify-center justify-items-center text-center pt-3 px-3 pb-0 rounded-md"
                    >
                        ...
                        <p className="flex gap-1 text-sm text-lighterSecondaryGrey mb-2">
