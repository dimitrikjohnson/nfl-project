        ...
        <section className="w-full mb-14">
            ...
            <div className="grid gap-7 grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8">
                { teams.map((x) =>
                    ...
                    key={ x.team.id } 
                    className="p-1.5 rounded-md transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-90 md:hover:scale-110 duration-300 motion-reduce:transition-none motion-reduce:hover:transform-none" 
