...
export default async function LandingPage() {
    ...
    return (
        <>             
            <div className="relative bg-black dark:bg-transparent w-full h-fit mb-16 md:mb-24">
                <Scoreboard />
                <NavBar />
                <img
                    src={ venueImage }
                ...
                />
                <section id="content" className="relative z-10 text-primary-dark flex flex-col items-start text-left md:items-center md:text-center px-4 max-w-2xl mt-24 mb-16 md:mb-36 mx-auto">
